...
(function () {
  ...
  const WORKS = [
    {
      ...
      fields: [
        { label: "Designed for", value: { tr: "Kuzey Tablo — Altın Çağ Koleksiyonu", en: "Kuzey Art — Golden Age Collection" } },
        { label: "Date", value: "2026" },
        { label: "Designed by", value: "İlayda Özen" },
      ],
      title: {
        tr: 'Taht ve Akıl:<br /><span class="t-nowrap">Süleyman İle Hürrem</span>',
        en: 'Throne and Wisdom:<br /><span class="t-nowrap">Süleyman and Hürrem</span>',
      },
      poem: {
    ...
    },
    {
      ...
      title: { tr: "Rafael ve İnci Küpeli Kız", en: "Raphael and the Girl with a Pearl Earring" },
      poem: {
    ...
    },
    {
      ...
      fields: [
        { label: "Designed for", value: { tr: "Kuzey Tablo Koleksiyonu", en: "Kuzey Art Collection" } },
        { label: "Date", value: "2025" },
        { label: "Designed by", value: "İlayda Özen" },
      ],
      title: { tr: "Anadolu’da Bir Siyah İnci", en: "A Black Pearl in Anatolia" },
      poem: {
    ...
    },
    {
      ...
      title: { tr: "Dualitenin Portresi", en: "The Portrait of Duality" },
      poem: {
    ...
    },
    {
      ...
      title: { tr: "Ters Düz Dünya", en: "Upside-Down World" },
      poem: {
    ...
    },
    {
      ...
      fields: [
        { label: "Designed for", value: { tr: "Ev ve Yaşam Fuarı Antalya", en: "Home & Living Fair, Antalya" } },
        { label: "Date", value: "2026" },
        { label: "Designed by", value: "İlayda Özen" },
      ],
      title: { tr: "Anadolu Leoparı", en: "The Anatolian Leopard" },
      poem: {
    ...
    },
    {
      ...
      title: { tr: "Arzular ve İhtiraslar", en: "Desires and Passions" },
      poem: {
    ...
    },
    {
      ...
      title: { tr: "Altın Sır ve Kadın", en: "The Golden Secret and the Woman" },
      poem: {
  ...
  /* Künye değeri: düz metin ya da {tr, en} nesnesi olabilir (dile göre çözülür) */
  ...
  function fill(i) {
    ...
    el.fields.innerHTML = w.fields
      .map(
        (f) =>
          `<div class="field"><dt>${labelFor(f.label)}</dt><dd>${valueFor(f.value)}</dd></div>`
      )
      .join("");

    const titleHtml = valueFor(w.title) || "";
    el.title.innerHTML = titleHtml;
    el.poem.innerHTML =
    ...
    el.img.alt = titleHtml.replace(/<[^>]+>/g, " ").trim();
    el.img.src = w.image;
  }
