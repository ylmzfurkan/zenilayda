...
(function () {
  ...
  const I18N = {
    tr: {
      ...
      /* --- Yaratıcı Süreç: kart başlıkları --- */
      "proc.tPortfolio": "Portfolyo",
      "proc.tAboutPortfolio": "Portfolyo Hakkında",
      "proc.tInteriorSection": "İç Mekan Bölümü",
      "proc.tStingray": "Vatoz",
      "proc.tBalance": "Denge",
      "proc.tBlackPearl": "Anadolu'da Bir Siyah İnci",
      "proc.tUpsideDown": "Ters-Düz Dünya",
      "proc.tCamazotz": "Camazotz",
      "proc.tPearlGirl": "İnci Küpeli Kız",
      "proc.tVeilAmber": "Kehribarın Tülü",
      "proc.tEchoes": "Siyah Heykelin Yankıları",
      "proc.tArtworkSpaces": "Mekanlarda Eserler",
      "proc.tInteriorMockup": "İç Mekan Mockup",
      "proc.tAboutProducts": "Tasarımlar Hakkında",
      "proc.tScreenPrint": "Ekrandan Baskıya",
      "proc.tGlassArtwork": "Cam Tablo",
      "proc.tThankYou": "Teşekkürler",
      /* --- Yaratıcı Süreç: kart alt başlıkları --- */
      "proc.sSelected": "Seçili Çalışmalar",
      "proc.sJourney": "Yaratıcı Yolculuk",
      "proc.sArtworksSpaces": "Mekanlarda Eserler",
      "proc.sBeforeAfter": "Önce & Sonra",
      "proc.sPhotoshop": "Photoshop Rötuşu",
      "proc.sMockups": "Mockup",
      "proc.sLiving": "Yaşam Alanları",
      "proc.sStatement": "İddialı Duvar",
      "proc.sElegant": "Zarif Kurgu",
      "proc.sKuzey": "Kuzey Home",
      "proc.sUvGlass": "UV Cam Baskı",
      "proc.sRealPrint": "Gerçek Baskı",
      "proc.sForTime": "Zaman Ayırdığınız İçin",

      /* --- Ana sayfa hero sözü (iki satır) --- */
      "hero.quote":
        '<span class="quote-line quote-line--tr">içimdeki <em>denizlerden</em></span><span class="quote-rule quote-rule-wide quote-rule--tr"></span><span class="quote-line quote-line--tr">dijital <em>sanata.</em></span>',
    ...
    en: {
      ...
      /* --- Creative Process: card titles --- */
      "proc.tPortfolio": "Portfolio",
      "proc.tAboutPortfolio": "About the Portfolio",
      "proc.tInteriorSection": "Interior Section",
      "proc.tStingray": "Stingray",
      "proc.tBalance": "Balance",
      "proc.tBlackPearl": "Black Pearl in Anatolia",
      "proc.tUpsideDown": "Upside Down World",
      "proc.tCamazotz": "Camazotz",
      "proc.tPearlGirl": "Girl with a Pearl Earring",
      "proc.tVeilAmber": "Veil of Amber",
      "proc.tEchoes": "Echoes of Black Sculpture",
      "proc.tArtworkSpaces": "Artwork in Spaces",
      "proc.tInteriorMockup": "Interior Mockup",
      "proc.tAboutProducts": "About the Products",
      "proc.tScreenPrint": "Screen to Print",
      "proc.tGlassArtwork": "Glass Artwork",
      "proc.tThankYou": "Thank You",
      /* --- Creative Process: card subtitles --- */
      "proc.sSelected": "Selected Works",
      "proc.sJourney": "The Creative Journey",
      "proc.sArtworksSpaces": "Artworks in Spaces",
      "proc.sBeforeAfter": "Before & After",
      "proc.sPhotoshop": "Photoshop Refinement",
      "proc.sMockups": "Mockups",
      "proc.sLiving": "In Living Spaces",
      "proc.sStatement": "Statement Wall",
      "proc.sElegant": "Elegant Setting",
      "proc.sKuzey": "Kuzey Home",
      "proc.sUvGlass": "UV Glass Printing",
      "proc.sRealPrint": "Real-Life Print",
      "proc.sForTime": "For Your Time",
